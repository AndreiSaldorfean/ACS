...
./simplesim-3.0/sim-spred.elf -redir:sim applu_simout_bpred.res -redir:prog applu_bpred -max:inst 50000000 ./inputs/ss_files/applu.ss < ./inputs/in_files/applu.in
