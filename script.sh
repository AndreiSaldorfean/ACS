...
./simplesim-3.0/sim-LVPred -redir:sim applu_simout_bpred.res -redir:prog applu_bpred -max:inst 50000000 -contor:LD 1 -bpred 2lev -bpred:2lev 1 1024 10 0 ./inputs/ss_files/applu.ss < ./inputs/in_files/applu.in
