...
{
  // Cache level 2 area
  double l2_up_area = 0.017046365126364 * 0.001530195554509;
  double l2_left_area = 0.006033970086292 * 0.015512726008696;
  ...
  // Register file area
  double reg_fp_area = 0.001476755399743 * 0.000214383302883;
  double reg_int_area = 0.001744193363179 * 0.000315239414318;
  ...
  fprintf(fp_pwr_trace, "%f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f\n",
      ...
      reg_fp_power, my_fp_exec_power, my_rename_power, my_itb_power, reg_int_power, my_instq_power, l2_left_power, 
      my_icache
    );
  fclose(fp_pwr_trace);
}