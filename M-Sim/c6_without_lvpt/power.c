...
{
  // Cache level 2 area
  double l2_up_area = 0.017131640737197 * 0.001029009288673;
  double l2_left_area = 0.006076876069544 * 0.016099313353485;
  ...
  double reg_int_area = 0.001743987919402 * 0.000315239414317;
