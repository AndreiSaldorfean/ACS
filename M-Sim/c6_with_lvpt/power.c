...
{
  // Cache level 2 area
  double l2_up_area = 0.017207893778236 * 0.000578409433983;
  double l2_left_area = 0.006114438841084 * 0.016626271413919;
  ...
  // Register file area
  double reg_fp_area = 0.000963863824119 * 0.000328321064852;
  double reg_int_area = 0.001744193363180 * 0.000315239414318;
  ...
  fprintf(fp_pwr_trace, "%f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f\n",
      ...
      reg_fp_power, my_fp_exec_power, my_rename_power, my_lvpt_power, my_itb_power, reg_int_power, 
