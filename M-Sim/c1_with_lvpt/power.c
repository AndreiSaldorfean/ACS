...
extern int LVPT_assoc;
extern int LVPT_history;
...
void update_power_stats()
{
  ...
  if(lvpt_access) {
    ...
    lvpt_power_cc2+=((double)lvpt_access/(double)commit_width) * power.lvpt_power;
    lvpt_power_cc3+=((double)lvpt_access/(double)commit_width) * power.lvpt_power;
  }
  else
  ...
  total_cycle_power = rename_power + bpred_power + lvpt_power + window_power + 
    lsq_power + regfile_power + icache_power + dcache_power +
    alu_power + resultbus_power;

  total_cycle_power_cc1 = rename_power_cc1 + bpred_power_cc1 + lvpt_power_cc1 + 
    window_power_cc1 + lsq_power_cc1 + regfile_power_cc1 + 
    icache_power_cc1 + dcache_power_cc1 + alu_power_cc1 + 
    resultbus_power_cc1;

  total_cycle_power_cc2 = rename_power_cc2 + bpred_power_cc2 + lvpt_power_cc2 + 
    window_power_cc2 + lsq_power_cc2 + regfile_power_cc2 + 
    icache_power_cc2 + dcache_power_cc2 + alu_power_cc2 + 
    resultbus_power_cc2;

  total_cycle_power_cc3 = rename_power_cc3 + bpred_power_cc3 + lvpt_power_cc3 + 
...
power_reg_stats(struct stat_sdb_t *sdb)	/* stats database */
{
  ...
  stat_reg_formula(sdb, "issue_stage_power", "total power usage of issue stage", "resultbus_power + lvpt_power + alu_power + dcache_power + dcache2_power + window_power + lsq_power", NULL);
  ...
  stat_reg_formula(sdb, "avg_issue_power", "average power of issue unit per cycle", "(resultbus_power + lvpt_power + alu_power + dcache_power + dcache2_power + window_power + lsq_power)/ sim_cycle", /* format */NULL);

  stat_reg_formula(sdb, "total_power", "total power per cycle","(rename_power + bpred_power + lvpt_power + window_power + lsq_power + regfile_power + icache_power  + resultbus_power + clock_power + alu_power + dcache_power + dcache2_power)", NULL);

  stat_reg_formula(sdb, "avg_total_power_cycle", "average total power per cycle","(rename_power + bpred_power + lvpt_power + window_power + lsq_power + regfile_power + icache_power + resultbus_power + clock_power + alu_power + dcache_power + dcache2_power)/sim_cycle", NULL);

  stat_reg_formula(sdb, "avg_total_power_cycle_nofp_nod2", "average total power per cycle","(rename_power + bpred_power + lvpt_power + window_power + lsq_power + regfile_power + icache_power + resultbus_power + clock_power + alu_power + dcache_power - falu_power )/sim_cycle", NULL);

  stat_reg_formula(sdb, "avg_total_power_insn", "average total power per insn","(rename_power + bpred_power + lvpt_power + window_power + lsq_power + regfile_power + icache_power + resultbus_power + clock_power + alu_power + dcache_power + dcache2_power)/sim_total_insn", NULL);

  stat_reg_formula(sdb, "avg_total_power_insn_nofp_nod2", "average total power per insn","(rename_power + bpred_power + lvpt_power + window_power + lsq_power + regfile_power + icache_power + resultbus_power + clock_power + alu_power + dcache_power - falu_power )/sim_total_insn", NULL);
  ...
  stat_reg_formula(sdb, "issue_stage_power_cc1", "total power usage of issue stage_cc1", "resultbus_power_cc1 + lvpt_power_cc1 + alu_power_cc1 + dcache_power_cc1 + dcache2_power_cc1 + lsq_power_cc1 + window_power_cc1", NULL);
  ...
  stat_reg_formula(sdb, "avg_issue_power_cc1", "average power of issue unit per cycle_cc1", "(resultbus_power_cc1 + lvpt_power_cc1 + alu_power_cc1 + dcache_power_cc1 + dcache2_power_cc1 + lsq_power_cc1 + window_power_cc1)/ sim_cycle", /* format */NULL);

  stat_reg_formula(sdb, "total_power_cycle_cc1", "total power per cycle_cc1","(rename_power_cc1 + bpred_power_cc1 + lvpt_power_cc1 + lsq_power_cc1 + window_power_cc1 + regfile_power_cc1 + icache_power_cc1 + resultbus_power_cc1 + clock_power_cc1 + alu_power_cc1 + dcache_power_cc1 + dcache2_power_cc1)", NULL);

  stat_reg_formula(sdb, "avg_total_power_cycle_cc1", "average total power per cycle_cc1","(rename_power_cc1 + bpred_power_cc1 + lvpt_power_cc1 + lsq_power_cc1 + window_power_cc1 + regfile_power_cc1 + icache_power_cc1 + resultbus_power_cc1 + clock_power_cc1 + alu_power_cc1 + dcache_power_cc1 +dcache2_power_cc1)/sim_cycle", NULL);

  stat_reg_formula(sdb, "avg_total_power_insn_cc1", "average total power per insn_cc1","(rename_power_cc1 + bpred_power_cc1 + lvpt_power_cc1 + lsq_power_cc1 + window_power_cc1 + regfile_power_cc1 + icache_power_cc1 + resultbus_power_cc1 + clock_power_cc1 +  alu_power_cc1 + dcache_power_cc1 + dcache2_power_cc1)/sim_total_insn", NULL);
  ...
  stat_reg_formula(sdb, "issue_stage_power_cc2", "total power usage of issue stage_cc2", "resultbus_power_cc2 + lvpt_power_cc2 + alu_power_cc2 + dcache_power_cc2 + dcache2_power_cc2 + lsq_power_cc2 + window_power_cc2", NULL);
  ...
  stat_reg_formula(sdb, "avg_issue_power_cc2", "average power of issue unit per cycle_cc2", "(resultbus_power_cc2 + lvpt_power_cc2 + alu_power_cc2 + dcache_power_cc2 + dcache2_power_cc2 + lsq_power_cc2 + window_power_cc2)/ sim_cycle", /* format */NULL);

  stat_reg_formula(sdb, "total_power_cycle_cc2", "total power per cycle_cc2","(rename_power_cc2 + bpred_power_cc2 + lvpt_power_cc2 + lsq_power_cc2 + window_power_cc2 + regfile_power_cc2 + icache_power_cc2 + resultbus_power_cc2 + clock_power_cc2 + alu_power_cc2 + dcache_power_cc2 + dcache2_power_cc2)", NULL);

  stat_reg_formula(sdb, "avg_total_power_cycle_cc2", "average total power per cycle_cc2","(rename_power_cc2 + bpred_power_cc2 + lvpt_power_cc2 + lsq_power_cc2 + window_power_cc2 + regfile_power_cc2 + icache_power_cc2 + resultbus_power_cc2 + clock_power_cc2 + alu_power_cc2 + dcache_power_cc2 + dcache2_power_cc2)/sim_cycle", NULL);

  stat_reg_formula(sdb, "avg_total_power_insn_cc2", "average total power per insn_cc2","(rename_power_cc2 + bpred_power_cc2 + lvpt_power_cc2 + lsq_power_cc2 + window_power_cc2 + regfile_power_cc2 + icache_power_cc2 + resultbus_power_cc2 + clock_power_cc2 + alu_power_cc2 + dcache_power_cc2 + dcache2_power_cc2)/sim_total_insn", NULL);
  ...
  stat_reg_double(sdb, "ialu_power_cc3", "total power usage of ialu_cc3", &ialu_power_cc3, 0, NULL);

  stat_reg_double(sdb, "falu_power_cc3", "total power usage of falu_cc3", &falu_power_cc3, 0, NULL);
  ...
  stat_reg_formula(sdb, "avg_ialu_power_cc3", "avg power usage of ialu_cc3", "ialu_power_cc3/sim_cycle",  NULL);

  stat_reg_formula(sdb, "avg_falu_power_cc3", "avg power usage of falu_cc3", "falu_power_cc3/sim_cycle",  NULL);
  ...
  stat_reg_formula(sdb, "issue_stage_power_cc3", "total power usage of issue stage_cc3", "resultbus_power_cc3 + lvpt_power_cc3 + alu_power_cc3 + dcache_power_cc3 + dcache2_power_cc3 + lsq_power_cc3 + window_power_cc3", NULL);
  ...
  stat_reg_formula(sdb, "avg_issue_power_cc3", "average power of issue unit per cycle_cc3", "(resultbus_power_cc3 + lvpt_power_cc3 + alu_power_cc3 + dcache_power_cc3 + dcache2_power_cc3 + lsq_power_cc3 + window_power_cc3)/ sim_cycle", /* format */NULL);

  stat_reg_formula(sdb, "total_power_cycle_cc3", "total power per cycle_cc3","(rename_power_cc3 + bpred_power_cc3 + lvpt_power_cc3 + lsq_power_cc3 + window_power_cc3 + regfile_power_cc3 + icache_power_cc3 + resultbus_power_cc3 + clock_power_cc3 + alu_power_cc3 + dcache_power_cc3 + dcache2_power_cc3)", NULL);

  stat_reg_formula(sdb, "avg_total_power_cycle_cc3", "average total power per cycle_cc3","(rename_power_cc3 + bpred_power_cc3 + lvpt_power_cc3 + lsq_power_cc3 + window_power_cc3 + regfile_power_cc3 + icache_power_cc3 + resultbus_power_cc3 + clock_power_cc3 + alu_power_cc3 + dcache_power_cc3 + dcache2_power_cc3)/sim_cycle", NULL);

  stat_reg_formula(sdb, "avg_total_power_insn_cc3", "average total power per insn_cc3","(rename_power_cc3 + bpred_power_cc3 + lvpt_power_cc3 + lsq_power_cc3 + window_power_cc3 + regfile_power_cc3 + icache_power_cc3 + resultbus_power_cc3 + clock_power_cc3 + alu_power_cc3 + dcache_power_cc3 + dcache2_power_cc3)/sim_total_insn", NULL);
     ...
     power_result_type *power;
{
  ...
  total_power = bpred_power + lvpt_power + rename_power + window_power + regfile_power +
     ...
     power_result_type *power;
{
  ...
  /* added by A. Gellert on 26 nov. 2012 */
  int LVPT_cols = 1/*TAG*/ + (LVPT_assoc>1 ? 1 : 0)/*eLRU*/ + 2*LVPT_history/*V_k,C_k*/ + (LVPT_history>1 ? LVPT_history : 0)/*vLRU_k*/;
  ...
  cache = 1;
  scale_factor = squarify(LVPT_size/*rows*/, LVPT_cols/*cols*/);
  predeclength = LVPT_size/scale_factor * (RegCellHeight + WordlineSpacing);
  wordlinelength = LVPT_cols*scale_factor *  (RegCellWidth + BitlineSpacing);
  bitlinelength = LVPT_size/scale_factor * (RegCellHeight + WordlineSpacing);
  if(verbose)
    fprintf(stderr,"LVPT power stats\n");
  power->lvpt_power = array_decoder_power(LVPT_size/scale_factor,LVPT_cols*scale_factor,predeclength,1,1,cache) + array_wordline_power(LVPT_size/scale_factor,LVPT_cols*scale_factor,wordlinelength,1,1,cache) + array_bitline_power(LVPT_size/scale_factor,LVPT_cols*scale_factor,bitlinelength,1,1,cache) + senseamp_power(LVPT_cols*scale_factor);
...
/* 
* print_power_trace function implementation
* @author Claudiu-Raul Buduleci, ULBS, 7/11/2012
*/
void print_power_trace(int sim_cycle) 
{
  // Cache level 2 area
  double l2_up_area = 0.006418369157333 * 0.003079196331762;
  double l2_left_area = 0.001321693883355 * 0.003339172825571;
  double l2_right_area = l2_left_area;
  double l2_area = l2_up_area + l2_left_area + l2_right_area;

  // Cache level 2 power
  double l2_up_power = ((l2_up_area / l2_area) * dcache2_power_cc3) / sim_cycle;
  double l2_left_power = ((l2_left_area / l2_area) * dcache2_power_cc3) / sim_cycle;
  double l2_right_power = ((l2_right_area / l2_area) * dcache2_power_cc3) / sim_cycle;

  double my_int_exec_power = ialu_power_cc3 / sim_cycle;
  double my_fp_exec_power = falu_power_cc3 / sim_cycle;
  double my_dtb_power = power.dtlb / sim_cycle;
  double my_ldstq_power = lsq_power_cc3 / sim_cycle;
  double my_bpred_power = bpred_power_cc3 / sim_cycle;

  // Register file area
  double reg_fp_area = 0.000748005586969 * 0.000423247774698;
  double reg_int_area = 0.001144604250732 * 0.000387146839957;
  double reg_total_area = reg_fp_area + reg_int_area;

  // Register file power
  double reg_fp_power = ((reg_fp_area / reg_total_area) * regfile_power_cc3) / sim_cycle;
  double reg_int_power = ((reg_int_area / reg_total_area) * regfile_power_cc3) / sim_cycle;

  double my_rename_power = rename_power_cc3 / sim_cycle;
  double my_itb_power = power.itlb / sim_cycle;
  double my_instq_power = window_power_cc3 / sim_cycle;
  double my_icache = icache_power_cc3 / sim_cycle;
  double my_dcache = dcache_power_cc3 / sim_cycle;

  // LVPT power
  double my_lvpt_power = lvpt_power_cc3 / sim_cycle;

  FILE *fp_pwr_trace;
  fp_pwr_trace = fopen("results/powerfile.ptrace", "a+");
  fprintf(fp_pwr_trace, "%f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f\n",
      my_int_exec_power, l2_up_power, my_dcache, l2_right_power, my_dtb_power, my_ldstq_power, my_bpred_power, 
      reg_fp_power, my_fp_exec_power, my_rename_power, my_lvpt_power, reg_int_power, my_itb_power, 
      my_instq_power, l2_left_power, my_icache
    );
  fclose(fp_pwr_trace);
}
