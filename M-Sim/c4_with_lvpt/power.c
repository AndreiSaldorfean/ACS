...
{
  // Cache level 2 area
  double l2_up_area = 0.008079113410088 * 0.005358449153841;
  double l2_left_area = 0.002152066009732 * 0.002720664256247;
  ...
  // Register file area
  double reg_fp_area = 0.001096024155105 * 0.000288854674116;
