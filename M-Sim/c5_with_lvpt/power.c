...
{
  // Cache level 2 area
  double l2_up_area = 0.017122991114964 * 0.001079976615411;
  double l2_left_area = 0.006072339646959 * 0.016039684069131;
  ...
  double reg_int_area = 0.001744193363178 * 0.000315239414319;
