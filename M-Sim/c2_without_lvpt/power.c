...
/* 
* print_power_trace function implementation, without LVPT
* @author Claudiu-Raul Buduleci, ULBS, 7/11/2012
*/
void print_power_trace(int sim_cycle) 
{
  // Cache level 2 area
  double l2_up_area = 0.008072278767056 * 0.005380856774168;
  double l2_left_area = 0.002148648688216 * 0.002691421992888;
  ...
  // Register file area
  double reg_fp_area = 0.001120551759860 * 0.000282531973522;
  double reg_int_area = 00.001144604250732 * 0.000387146839957;
  ...
  fprintf(fp_pwr_trace, "%f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f\n",
      ...
      reg_fp_power, my_fp_exec_power, my_rename_power, reg_int_power, my_itb_power, my_instq_power, l2_left_power, 
      my_icache
    );
  fclose(fp_pwr_trace);
}